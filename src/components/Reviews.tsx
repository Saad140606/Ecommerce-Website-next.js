    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        >
          ...
          {/* Testimonial 1 */}
          <div className="p-4 md:w-1/2  flex-shrink-0">
            <div className="h-full theme bg-opacity-90 p-6 rounded flex flex-col box-border ">
              ...
              <p className="leading-relaxed mb-6 text-white text-sm flex-grow overflow-auto">
                Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra <br/> before they sold out fixie 90s microdosing. Tacos pinterest fanny pack venmo,<br/> post-ironic heirloom try-hard pabst authentic iceland.
              </p>
