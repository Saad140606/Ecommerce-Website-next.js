    ...
    <>
      ...
      <section className="max-w-screen-xl py-16 mx-auto px-7 sm:px-14" id="projects">
        <div className="flex items-center justify-center gap-12 pb-12">
          ...
          <h2 className="text-4xl font-bold text-center wordTheme mb-10 md:mb-0">Our Vission</h2>
          <div className="flex-1 hidden h-px bg-slate-50 sm:block"></div>
        </div>
        <div>
          <div className="flex flex-col mt-20 sm:flex-row sm:gap-12">
            ...
            <p className="theme text-3xl tracking-wide pl-8 pr-2 py-4 md:mb-2 mb-32 rounded shadow-sm sm:relative sm:right-[10%] lg:right-1/4 text-white">
             At FabricNest, our vision is to redefine the way people experience fashion. We aim to create a platform where style meets comfort, providing customers with high-quality clothing. We aspire to be a trusted name in the fashion industry. 
              </p>
            </div>
          </div>
        </div>
